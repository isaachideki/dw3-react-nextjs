...
// recebe a props dentro do parametro do componente

const EditContent = ({game, onClose}) => {
    
    // criando estado para armazenar dados do formulario
    ...
    // useEffect -> utilizar quando você quer que algo seja executado assim que o componente é carregado
    useEffect(() => {
    ...
    }, [game]) // -> Dependência do useEffect. É o que faz o useEffect ser executado novamente, quando aquela informação for alterada
